...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Iyanu\Desktop\ireoluwa\django\zuri django demo final project\demo_django'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Iyanu\Desktop\ireoluwa\django\zuri django demo final project\demo_django\Scripts\deactivate.nu'
